...
const RESPONSE_LINES = [
  ...
  { text: "→ AI/ML Intern @ Aeroseal: production RAG chatbot on a 2-tier prompt architecture", type: "bullet" },
  { text: "→ Director of Workshops @ GT Big Data Big Impact: ML curriculum for 100+ students · LSTM forecasting", type: "bullet" },
